(function() {
  ...
  var printed$2 = {};
  var warnOnce$2$2 = function warnOnce23(message) {
  ...
  var tokenize$2 = function tokenizer23(input2, options) {
    if (options === void 0) options = {};
    var css = input2.css.valueOf();
    var ignore = options.ignoreErrors;
    var code, next, quote, content, escape;
  ...
  var extract_domain = function(hostname2) {
    var domain_regex = DOMAIN_MATCH_REGEX;
    var parts = hostname2.split(".");
    var tld = parts[parts.length - 1];
    if (tld.length > 4 || tld === "com" || tld === "org") {
      domain_regex = SIMPLE_DOMAIN_MATCH_REGEX;
    }
    var matches = hostname2.match(domain_regex);
  ...
  SessionRecording.prototype._flushEvents = addOptOutCheckMixpanelLib(function(data, options, callback) {
    ...
    if (numEvents > 0) {
      ...
      if (canUseCompressionStream(userAgent, navigator$1.vendor, windowOpera)) {
  ...
  function sanitize(payload = {}) {
    return Object.fromEntries(
      Object.entries(payload).filter(([_2, value]) => {
  ...
  class AutoTrack {
    ...
    extractProperties(element) {
      ...
      Array.from(element.attributes).forEach((attribute) => {
        ...
        const property = attribute.name.replace("data-mp-", "").replace(/-([a-z])/g, (_2, letter) => letter.toUpperCase());
